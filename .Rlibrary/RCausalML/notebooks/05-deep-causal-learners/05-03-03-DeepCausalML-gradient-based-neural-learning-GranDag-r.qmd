...
The **RCausalML** package provides GraN-DAG via `R/causalDeepNet.R`. The implementation includes the following main classes and functions:
...
# Use development sources when rendering from the package tree
pkg_root <- if (file.exists("DESCRIPTION")) "." else if (file.exists("../DESCRIPTION")) ".." else NULL
