# Treatment Effect Estimators {.unnumbered}
...
5. **GANITE** — Yoon, Jordon & van der Schaar (2018). *GANITE: Estimation of individualized treatment effects using generative adversarial nets.* ICLR.
